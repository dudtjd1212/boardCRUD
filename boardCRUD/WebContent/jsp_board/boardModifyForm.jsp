...
%>    
        <form action="<%=request.getContextPath()%>/jsp_board/boardModifyAction.jsp" method="post">
            <div>boardNo</div>
            <div><input name="boardNo" value="<%=boardNo%>" type="text" readonly="readonly" class="alert alert-info"/></div>
            <div >비밀번호확인: </div>
            <div><input name="boardPw" class="alert alert-info" id="boardPw" type="password" /></div>
            <div>boardTitle : </div>
            <div><input name="boardTitle" value="<%=boardTitle%>" id="boardTitle" type="text" class="alert alert-info"/></div>
            <div>boardContent : </div>
            <div><textarea name="boardContent" id="boardContent" rows="5" cols="50" class="alert alert-info"><%=boardContent%></textarea></div>
            <div>
